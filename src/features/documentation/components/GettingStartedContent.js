    ...
    <>
      <article className="prose">
        ...
        <p>
          ...
          <span className="font-bold">fully customizable and themable CSS</span>{" "}
          and power of Tailwind CSS utility classes. We have also added{" "}
          <span className="font-bold">Zustand</span> and configured it for API
          calls and state management.
        </p>
        <p>
          User authentication has been implemented using JWT token method
          (ofcourse you need backend API for generating and verifying token).
          This template can be used to start your next SaaS project or build new
          internal tools in your company.
        </p>
        ...
        <p className="">
          Almost all major UI components are available in Daisy UI library.
          Apart from this logic has been added for following -{" "}
        </p>
        <ul>
          <li>
            {" "}
          ...
          <li>
            {" "}
            Store management using <span className="font-bold">Zustand</span>
          </li>
          <li>
            {" "}
        ...
        <p>
          ...
          that you can use to build and design the UI directly in the JSX. We
          have also included Daisy UI Component, that is based on tailwind CSS.
        </p>
        ...
        <p>
          ...
          used for this template. It has a rich collection of components,
          layouts and is fully customizable and themeable.
        </p>
        ...
        <ul className="mt-0">
          <li>
            ...
            <span className="badge badge-accent">Zustand store</span>), auth and
            libraries settings are present
          </li>
          <li>
          ...
          <li>
            ...
            different functionalities like components, modals etc...
          </li>
          <li>
